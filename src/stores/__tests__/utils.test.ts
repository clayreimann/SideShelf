...
describe('Store Utils', () => {
  describe('Constants', () => {
    ...
    it('should have correct default sort configs', () => {
      expect(DEFAULT_SORT_CONFIG).toEqual({ field: 'title', direction: 'desc' });
  ...
  describe('sortLibraryItems', () => {
    ...
    describe('Sort by author', () => {
      it('should sort by author ascending using authorNameLF', () => {
        const result = sortLibraryItems(mockItems, { field: 'author', direction: 'asc' });
      ...
      it('should sort by author descending', () => {
        const result = sortLibraryItems(mockItems, { field: 'author', direction: 'desc' });
      ...
      it('should fallback to author field when authorNameLF is null', () => {
        ...
        const result = sortLibraryItems(itemsWithoutLF, { field: 'author', direction: 'asc' });
    ...
    describe('Sort by published year', () => {
      ...
      it('should handle null published years', () => {
        ...
        const result = sortLibraryItems(itemsWithNullYear, { field: 'publishedYear', direction: 'asc' });
