...
export default function LibraryItemDetail({ itemId, onTitleChange }: LibraryItemDetailProps) {
          ...
          },
          {
            ...
            onPress: async () => {
              try {
                ...
                console.error("[LibraryItemDetail] Failed to delete bookmark:", error);
  ...
  // Handler for jumping to a bookmark
    ...
    async (time: number) => {
      ...
      try {
        ...
        if (isThisItemPlaying) {
          ...
          await playerService.playTrack(item.id, time);
        }
      } catch (error) {
        console.error("[LibraryItemDetail] Failed to jump to bookmark:", error);
    ...
    <>
      ...
      >
        ...
        {itemBookmarks.length > 0 && (
          <CollapsibleSection
            title={`Bookmarks (${itemBookmarks.length})`}
            ...
            {itemBookmarks
              ...
              .map((bookmark, index) => (
                <View
                  ...
                  style={{
                    paddingVertical: 12,
                    borderBottomWidth: index < itemBookmarks.length - 1 ? 1 : 0,
