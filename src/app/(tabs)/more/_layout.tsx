  ...
  return (
    <TabErrorBoundary tabName="More">
      ...
      >
        ...
        <Stack.Screen name="series/[seriesId]/index" options={{ title: translate("tabs.series") }} />
        <Stack.Screen name="authors/[authorId]/index" options={{ title: translate("tabs.authors") }} />
        <Stack.Screen name="series/[seriesId]/item/[itemId]" options={{ headerTitle: "", headerBackButtonDisplayMode: "minimal" }} />
        <Stack.Screen name="authors/[authorId]/item/[itemId]" options={{ headerTitle: "", headerBackButtonDisplayMode: "minimal" }} />
